...
class WebSocketClinet : public WebSocketClientProcess
{
public:
    explicit WebSocketClinet();
    ~WebSocketClinet() override;
    WebSocketClinet(const WebSocketClinet&) = delete;
    WebSocketClinet& operator=(const WebSocketClinet&) = delete;
